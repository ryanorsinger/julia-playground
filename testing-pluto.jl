...
# ╔═╡ 7a81b97e-fae7-11ea-2ef2-9768a7d4362f
friend = "Ryan"
...
# ╔═╡ 90708aaa-fae7-11ea-31ee-d3d84717608a
.1 + .2 ≈ 0.3

# ╔═╡ 0508c34e-fae8-11ea-17f8-332503fbd513
√4.2

# ╔═╡ 72c00416-fae9-11ea-24eb-7dee7217d4eb
2+2
...
neighbors = [cat, friend, "Smerfetka", "Latte", "Fozzy", "Mongo", "Mango", "Dweeba", "Miffy", "Spiffy", "Biff"]
...
# ╔═╡ 653646bc-faea-11ea-301b-3b8ef032f870
@bind nickname html"<input type='text'>"
...
# ╔═╡ 42446826-faea-11ea-2db4-e12b4de8d601
@bind x html"<input type='range'>"

# ╔═╡ 18d86874-faeb-11ea-0edb-8959e9340df3
f(x) = x^2

# ╔═╡ feba9bd8-faea-11ea-3b03-4194b0343d24
y = f(x)

# ╔═╡ 70fca2b4-faea-11ea-09f9-23d0ee01d59f
repeat(nickname, y)
